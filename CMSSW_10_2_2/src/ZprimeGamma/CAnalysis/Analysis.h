...
// Fri Feb 15 13:43:54 2019 by ROOT version 6.12/07
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nElectron;
   Float_t         Electron_deltaEtaSC[60];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[60];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[60];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[60];   //[nElectron]
   Float_t         Electron_dxy[60];   //[nElectron]
   Float_t         Electron_dxyErr[60];   //[nElectron]
   Float_t         Electron_dz[60];   //[nElectron]
   Float_t         Electron_dzErr[60];   //[nElectron]
   Float_t         Electron_eCorr[60];   //[nElectron]
   Float_t         Electron_eInvMinusPInv[60];   //[nElectron]
   Float_t         Electron_energyErr[60];   //[nElectron]
   Float_t         Electron_eta[60];   //[nElectron]
   Float_t         Electron_hoe[60];   //[nElectron]
   Float_t         Electron_ip3d[60];   //[nElectron]
   Float_t         Electron_mass[60];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[60];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[60];   //[nElectron]
   Float_t         Electron_mvaSpring16GP[60];   //[nElectron]
   Float_t         Electron_mvaSpring16HZZ[60];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[60];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[60];   //[nElectron]
   Float_t         Electron_phi[60];   //[nElectron]
   Float_t         Electron_pt[60];   //[nElectron]
   Float_t         Electron_r9[60];   //[nElectron]
   Float_t         Electron_sieie[60];   //[nElectron]
   Float_t         Electron_sip3d[60];   //[nElectron]
   Float_t         Electron_mvaTTH[60];   //[nElectron]
   Int_t           Electron_charge[60];   //[nElectron]
   Int_t           Electron_cutBased[60];   //[nElectron]
   Int_t           Electron_cutBased_HLTPreSel[60];   //[nElectron]
   Int_t           Electron_jetIdx[60];   //[nElectron]
   Int_t           Electron_pdgId[60];   //[nElectron]
   Int_t           Electron_photonIdx[60];   //[nElectron]
   Int_t           Electron_tightCharge[60];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[60];   //[nElectron]
   Bool_t          Electron_convVeto[60];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[60];   //[nElectron]
   Bool_t          Electron_isPFcand[60];   //[nElectron]
   UChar_t         Electron_lostHits[60];   //[nElectron]
   Bool_t          Electron_mvaSpring16GP_WP80[60];   //[nElectron]
   Bool_t          Electron_mvaSpring16GP_WP90[60];   //[nElectron]
   Bool_t          Electron_mvaSpring16HZZ_WPL[60];   //[nElectron]
   ...
   Float_t         FatJet_msoftdrop_chs[50];   //[nFatJet]
   ...
   UInt_t          nGenJet;
   Float_t         GenJet_eta[190];   //[nGenJet]
   Float_t         GenJet_mass[190];   //[nGenJet]
   Float_t         GenJet_phi[190];   //[nGenJet]
   Float_t         GenJet_pt[190];   //[nGenJet]
   UInt_t          nGenPart;
   ...
   UChar_t         LHE_NpLO;
   UInt_t          nLHEPart;
   Float_t         LHEPart_pt[40];   //[nLHEPart]
   Float_t         LHEPart_eta[40];   //[nLHEPart]
   Float_t         LHEPart_phi[40];   //[nLHEPart]
   Float_t         LHEPart_mass[40];   //[nLHEPart]
   Int_t           LHEPart_pdgId[40];   //[nLHEPart]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Int_t           Photon_cutBased[50];   //[nPhoton]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[80];   //[nSubJet]
   Float_t         SubJet_btagCSVV2[80];   //[nSubJet]
   Float_t         SubJet_btagDeepB[80];   //[nSubJet]
   Float_t         SubJet_eta[80];   //[nSubJet]
   Float_t         SubJet_mass[80];   //[nSubJet]
   Float_t         SubJet_n2b1[80];   //[nSubJet]
   Float_t         SubJet_n3b1[80];   //[nSubJet]
   Float_t         SubJet_phi[80];   //[nSubJet]
   Float_t         SubJet_pt[80];   //[nSubJet]
   Float_t         SubJet_tau1[80];   //[nSubJet]
   Float_t         SubJet_tau2[80];   //[nSubJet]
   Float_t         SubJet_tau3[80];   //[nSubJet]
   Float_t         SubJet_tau4[80];   //[nSubJet]
   UInt_t          nTau;
   Float_t         Tau_chargedIso[40];   //[nTau]
   Float_t         Tau_dxy[40];   //[nTau]
   Float_t         Tau_dz[40];   //[nTau]
   Float_t         Tau_eta[40];   //[nTau]
   Float_t         Tau_leadTkDeltaEta[40];   //[nTau]
   Float_t         Tau_leadTkDeltaPhi[40];   //[nTau]
   Float_t         Tau_leadTkPtOverTauPt[40];   //[nTau]
   Float_t         Tau_mass[40];   //[nTau]
   Float_t         Tau_neutralIso[40];   //[nTau]
   Float_t         Tau_phi[40];   //[nTau]
   Float_t         Tau_photonsOutsideSignalCone[40];   //[nTau]
   Float_t         Tau_pt[40];   //[nTau]
   Float_t         Tau_puCorr[40];   //[nTau]
   Float_t         Tau_rawAntiEle[40];   //[nTau]
   Float_t         Tau_rawIso[40];   //[nTau]
   Float_t         Tau_rawIsodR03[40];   //[nTau]
   Float_t         Tau_rawMVAnewDM[40];   //[nTau]
   Float_t         Tau_rawMVAoldDM[40];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR03[40];   //[nTau]
   Int_t           Tau_charge[40];   //[nTau]
   Int_t           Tau_decayMode[40];   //[nTau]
   Int_t           Tau_jetIdx[40];   //[nTau]
   Int_t           Tau_rawAntiEleCat[40];   //[nTau]
   UChar_t         Tau_idAntiEle[40];   //[nTau]
   UChar_t         Tau_idAntiMu[40];   //[nTau]
   Bool_t          Tau_idDecayMode[40];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[40];   //[nTau]
   UChar_t         Tau_idMVAnew[40];   //[nTau]
   UChar_t         Tau_idMVAoldDM[40];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR03[40];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[27];   //[nTrigObj]
   Float_t         TrigObj_eta[27];   //[nTrigObj]
   Float_t         TrigObj_phi[27];   //[nTrigObj]
   Float_t         TrigObj_l1pt[27];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[27];   //[nTrigObj]
   Float_t         TrigObj_l2pt[27];   //[nTrigObj]
   Int_t           TrigObj_id[27];   //[nTrigObj]
   Int_t           TrigObj_l1iso[27];   //[nTrigObj]
   Int_t           TrigObj_l1charge[27];   //[nTrigObj]
   Int_t           TrigObj_filterBits[27];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           PV_npvsGood;
   UInt_t          nSV;
   Float_t         SV_dlen[90];   //[nSV]
   Float_t         SV_dlenSig[90];   //[nSV]
   Float_t         SV_pAngle[90];   //[nSV]
   ...
   Int_t           GenJet_partonFlavour[190];   //[nGenJet]
   UChar_t         GenJet_hadronFlavour[190];   //[nGenJet]
   ...
   UChar_t         Tau_cleanmask[40];   //[nTau]
   Float_t         SV_chi2[90];   //[nSV]
   Float_t         SV_eta[90];   //[nSV]
   Float_t         SV_mass[90];   //[nSV]
   Float_t         SV_ndof[90];   //[nSV]
   Float_t         SV_phi[90];   //[nSV]
   Float_t         SV_pt[90];   //[nSV]
   Float_t         SV_x[90];   //[nSV]
   Float_t         SV_y[90];   //[nSV]
   Float_t         SV_z[90];   //[nSV]
   Int_t           Tau_genPartIdx[40];   //[nTau]
   UChar_t         Tau_genPartFlav[40];   //[nTau]
   ...
   // My Methods
   void     DoAnalysis(double weight=1.0, double lum=1.0);
   void     Book(const char * outputFilename);
   void     Output();
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/cms/evah/workspace/CMSSW_9_4_9/src/old_runs/VectorDiJet1Gamma_75_13TeV-madgraph/MultiN/VectorDiJet1Gamma_75_13TeV-madgraph_job_0_.root");
      chain->Add("/cms/evah/workspace/CMSSW_9_4_9/src/old_runs/VectorDiJet1Gamma_75_13TeV-madgraph/MultiN/VectorDiJet1Gamma_75_13TeV-madgraph_job_1_.root");
      tree = chain;
#endif // SINGLE_TREE
