...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:root://cms-xrd-global.cern.ch//store/data/Run2018A/EGamma/MINIAOD/17Sep2018-v2/110000/B5393DE0-15CD-CB4C-95F1-78A065204256.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:jetToolbox_nano_datatest1125.root'),
